...
//     const strategyDropdown = getAllByText('Strategy')[0];
//     const asssetClassDropdown = getAllByText('Asset Class')[0];
//     const marketAndRegionDropdown = getAllByText('Market & Region')[0];
//     const styleDropdown = getAllByText('Style')[0];
//     const searchInput = getByPlaceholderText('Enter fund name');

//     expect(searchInput).toBeInTheDocument();

//     expect(strategyDropdown).toBeInTheDocument();
//     expect(asssetClassDropdown).toBeInTheDocument();
//     expect(marketAndRegionDropdown).toBeInTheDocument();
//     expect(styleDropdown).toBeInTheDocument();
//   });

//   test('filters data correctly based on search input', async () => {
//     const mockSetSearchQuery = jest.fn();
//     const { getByPlaceholderText, getByText } = render(<DataTableContainer setSearchQuery={mockSetSearchQuery}/>);
...
//     await waitFor(() => {
//       expect(mockSetSearchQuery).toHaveBeenCalledWith('NASDAQ');
//     });
//   });

//   test('filters data correctly based on Strategy dropdown selection', async () => {
//     const mockSetStrategyFilter = jest.fn();
//     const { getByText, getAllByText } = render(<DataTableContainer />);
//     const strategyDropdown = getAllByText('Strategy')[0];

//     fireEvent.click(strategyDropdown);
//     const strategyOption = getByText('Thematic'); // Adjust to your specific strategy option
//     fireEvent.click(strategyOption);

//     await waitFor(() => {
//       // You need to mock setStrategyFilter to assert its invocation
//       expect(mockSetStrategyFilter).toHaveBeenCalledWith(['Thematic']);
//     });
//   });

// //   // Similar tests for filtering based on Asset Class, Market & Region, and Style dropdown selections
